...
def main():
    ...
    instance_name = os.path.basename(args.instance)  # Get the instance name without the path
    ...
    print(f"{instance_name};{initial_eval};{best_evaluation};{improvement:.2f};{execution_time:.2f};{best_solution.cities}")
