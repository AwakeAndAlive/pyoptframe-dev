...
pTSP.load('instances/01_berlin52.tsp')
...
brkga = BRKGA(pTSP.engine, drk_rk_id, c_rk_idx, population_size, num_generations, elite_proportion, mutant_proportion, elite_inheritance_probability)
...
print(f"BRKGA parameters: population size = {population_size}, num generations = {num_generations}, elite proportion = {elite_proportion}, mutant proportion = {mutant_proportion}, elite inheritance probability = {elite_inheritance_probability}")
